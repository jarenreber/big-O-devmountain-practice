...
// ANSWER: No, since it is already stops at the 4th run through.
 wrong: const theFourth = numbers => numbers[4]
...
// ANSWER:
const numSquared = numbers => {
  for (let i = 0; i < numbers.length; i++) {
    let numSquared = []
    numSquared.push(numbers[i] * numbers[i])
  }
  return numSquared
}
...
// ANSWER: It is based off of how long their string is 
